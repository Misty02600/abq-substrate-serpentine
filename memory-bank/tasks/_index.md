...
## In Progress
- [TASK015] 基于 RPY 的路径 LE 后处理导出 - 脚本已实现，待 Abaqus/CAE 实跑验证
- [TASK013] Wire 翻转方案重构 - 采用方案A，草图阶段Y坐标翻转，已实施代码修改
- [TASK012] 动力学分析步配置 - 已完成配置类和创建函数，待更新 Pydantic 模型
- [TASK009] Hydra+Pydantic 配置重构 - 本地 Python 部分已完成，待创建 ABAQUS 读取脚本

## Pending
- [TASK014] ABAQUS Python 环境配置与脚本运行优化 - 安装 pandas、editable install、清理 sys.path hack
